...
2026-09-15 documentation sync: Store Manager Home / trade-in / capture / Highest Offer UX was recorded back into [design.md](design.md) and [design.html](design.html) so the HTML prototype matches the live Flutter app (branch/user app bar, platform-first 15-digit GSMA IMEI, merged 9-step bar, capture grid, app-top Back). No API or phase status change.
