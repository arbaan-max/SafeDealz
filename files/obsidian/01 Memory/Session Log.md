...
- Completed P00 Flutter and backend bootstrap.
- Configured Swagger-driven Dio/Retrofit clients and Freezed DTO generation for all three Flutter apps.
- Consolidated the repository into backend, flutter, files, and react.
