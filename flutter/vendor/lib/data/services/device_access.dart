...
Future<void> prepareVendorAccess(Dio dio) async {
  if (_inWidgetTest()) return;
  try {
    final needed = <Permission>[Permission.notification, Permission.camera];
...
Future<void> _explainAccess() async {
  ...
  await showDialog<void>(
    ...
    builder: (context) => AlertDialog(
      ...
      content: const Text(
        'SafeDealz needs notifications for new trade-ins and camera access for pickup photos.',
      ),
      actions: [
        TextButton(
